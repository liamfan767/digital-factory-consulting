    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-white shadow-sm">
      <div className="section-container">
        <div className="flex items-center justify-between h-20">
          ...
          {/* Desktop Navigation - All Main Menu Items Visible */}
          <nav className="hidden md:flex items-center gap-6 flex-1 justify-center">
            ...
            >
              <button
                type="button"
                className="flex items-center gap-1 text-gray-700 hover:text-[hsl(var(--primary))] transition-colors font-medium h-full px-2"
              >
                {t.nav.services}
            ...
            {/* Referenzen - Regular Link (Always Visible) */}
            <Link
              href="#references"
              className="text-gray-700 hover:text-[hsl(var(--primary))] transition-colors font-medium px-2"
            >
              {t.nav.references}
            </Link>

            {/* Insights - Regular Link (Always Visible) */}
            <Link
              href="#insights"
              className="text-gray-700 hover:text-[hsl(var(--primary))] transition-colors font-medium px-2"
            >
          ...
          <div className="hidden md:flex items-center gap-4">
            <Link
              href="#contact"
              className="bg-[hsl(var(--accent))] text-white px-6 py-2.5 rounded-md font-medium hover:opacity-90 transition-opacity text-sm whitespace-nowrap"
            >
              {t.nav.contact}
            </Link>
          </div>

          {/* Language Switcher (Always Visible) & Mobile Menu Button */}
          <div className="flex items-center gap-3">
            ...
            <button
              type="button"
              className="md:hidden p-2 text-gray-700 hover:text-[hsl(var(--primary))] transition-colors"
